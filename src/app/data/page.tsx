                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span className={`px-2.5 py-1 rounded-full text-xs font-bold whitespace-nowrap ${
                        item.kategori === 'Anomali Ekstrem' ? 'bg-red-100 text-red-700' :
                        item.kategori === 'Tinggi' ? 'bg-orange-100 text-orange-700' :
                        item.kategori === 'Sedang' ? 'bg-yellow-100 text-yellow-700' :
                        item.kategori === 'Rendah' ? 'bg-green-100 text-green-700' :
